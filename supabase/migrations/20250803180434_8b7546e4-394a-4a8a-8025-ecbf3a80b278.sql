...
-- First, let's ensure we have the client role
INSERT INTO public.user_roles (id, name, permissions) 
VALUES ('client-role-id', 'client', '{"portal_access": true}')
ON CONFLICT (name) DO NOTHING;

-- Create test client profile
-- Note: We'll insert with a placeholder ID that matches what we'll use in auth
