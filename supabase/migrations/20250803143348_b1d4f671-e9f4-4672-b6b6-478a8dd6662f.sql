...
-- 3. Enhance existing contact_inquiries table
...
-- 5. Create company_comments table
...
-- 6. Create initial admin role
INSERT INTO user_roles (name, permissions) 
VALUES ('admin', '{"all": true}'::jsonb);

-- 7. Create security definer function to check admin status
...
-- 10. Create RLS policies for contact_inquiries
...
-- 11. Create RLS policies for activity_log
...
-- 12. Create RLS policies for company_comments
...
-- 14. Create trigger for updating profiles.updated_at
